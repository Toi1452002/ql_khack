...
class KhachData {
  ...
  Future<Response> getAllKhach({int theoDoi = 1}) async {
    return _dio.get(
      PathServer.khach,
      queryParameters: PathServer.push(type: 'get-all', data: {'TheoDoi': theoDoi}),
    );
  }

  Future<Response> getKhachNgungTD() async {
    return _dio.get(PathServer.khach, queryParameters: PathServer.push(type: 'get-khach-ngung-td'));
  }
